...
class DataList extends React.Component {
	...
	render() {
		...
		if (fieldMap.itemContainer === null) {
			...
			for (const { parent, node, key, path } of new RecursiveIterator(objectData)) {
				if (!(typeof node === 'object' && node !== null)) {
					const pathString = path.join('.');
			...
			return (
				<div className="grid nav-menus-php">
					...
					<div className="grid__item">
						<ViewOption view={view} setView={this.setView.bind(this)} translation={translation} />
